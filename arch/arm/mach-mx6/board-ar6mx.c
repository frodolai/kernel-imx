...
static struct platform_pwm_backlight_data mx6_arm2_pwm_backlight_data0 = {
	.pwm_id			= 0,
	.max_brightness		= 255,
	.dft_brightness		= 255,
	.pwm_period_ns		= 50000,
...
static struct platform_pwm_backlight_data mx6_arm2_pwm_backlight_data1 = {
	.pwm_id			= 1,
	.max_brightness		= 255,
	.dft_brightness		= 255,
	.pwm_period_ns		= 50000,
...
static void __init mx6_board_init(void)
{
  ...
  imx6q_add_mxc_pwm(1);
	...
	imx6q_add_mxc_pwm_backlight(0, &mx6_arm2_pwm_backlight_data0);
	imx6q_add_mxc_pwm_backlight(1, &mx6_arm2_pwm_backlight_data1);
	#if 0
...
MACHINE_START(AR6MXQ, "Freescale i.MX 6Quad/DualLite/Solo AR6MXS/Q Board")
